      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-muted-foreground">Redeem your points for eco-friendly rewards and experiences</p>
          </div>
          ...
          <>
            ...
            {filteredAndSortedItems?.length > 0 ? (
              ...
              <div className="text-center py-12">
                ...
                <h3 className="text-xl font-semibold text-foreground mb-2">No rewards found</h3>
